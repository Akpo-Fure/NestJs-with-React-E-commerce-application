            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, { message: 'Sign up successful', user: user }];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        if (!user)
                            return [2 /*return*/, { message: 'invalid credentials' }];
                        return [4 /*yield*/, argon.verify(user.password, dto.password)];
                    case 2:
                        verify = _a.sent();
                        if (!verify)
                            return [2 /*return*/, { message: 'invalid credentials' }];
                        payload = { sub: user.id, admin: user.isAdmin };
                        return [4 /*yield*/, this.jwt.signAsync(payload)];
                    case 3:
                        token = _a.sent();
                        return [2 /*return*/, { message: 'Log in successful', token: token }];
                }
            });
        });
    };

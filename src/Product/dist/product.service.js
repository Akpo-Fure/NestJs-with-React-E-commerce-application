...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.createProduct = function (userId, dto) {
        return __awaiter(this, void 0, void 0, function () {
            var product;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prisma.product.create({
    ...
    ProductService.prototype.updateProduct = function (productId, dto) {
        return __awaiter(this, void 0, void 0, function () {
            var product;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        product = _a.sent();
                        return [2 /*return*/, { message: 'Product updated successfully', product: product }];
                }
            });
        });
    };
